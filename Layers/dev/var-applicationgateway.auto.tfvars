...
key_vault_resource_group = "[__ado_resource_group_name__]"
key_vault_name           = "[__ado_key_vault_name__]"
ado_subscription_id      = "[__ado_subscription_id__]"

application_gateways = {
  "appgw1" = {
    name                       = "jstartvm03052021appgw"
    zones                      = ["1", "2", "3"]
    enable_http2               = true
    ...
    backend_http_settings = [
      ...
      },
      {
        ...
        host_name                           = "admin.techchannel.att.com"
        pick_host_name_from_backend_address = false
      },
      {
    ...
    http_listeners = [
      ...
      },
      {
        ...
        sni_required                   = false
        listener_type                  = "MultiSite"
        host_name                      = "techchanneldev.att.com"
        host_names                     = null
        webapp_firewall_policy_key     = null
      },
      {
        ...
        sni_required                   = false
        listener_type                  = "MultiSite"
        host_name                      = "admin.techchanneldev.att.com"
        host_names                     = null
        webapp_firewall_policy_key     = null
      },
      {
    ...
    probes = [
      ...
      },
      {
        ...
        path                                      = "/"
        protocol                                  = "Https"
        host                                      = "admin.techchannel.att.com"
        interval                                  = null
        timeout                                   = null
        unhealthy_threshold                       = null
        pick_host_name_from_backend_http_settings = false
